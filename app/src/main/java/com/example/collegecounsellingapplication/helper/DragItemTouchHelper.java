package com.example.collegecounsellingapplication.helper;
...
public class DragItemTouchHelper extends ItemTouchHelper.Callback {
    ...
    private final AdapterCollegeListDrag adapterCollegeListDrag;

    public DragItemTouchHelper(MoveHelperAdapter adapter, AdapterCollegeListDrag adapterCollegeListDrag) {
        mAdapter = adapter;
        this.adapterCollegeListDrag = adapterCollegeListDrag;
    }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        adapterCollegeListDrag.notifyDataSetChanged();
        Log.i("info2", "clearView: notified");
